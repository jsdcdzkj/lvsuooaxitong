package com.jsdc.lsoa.common.utils;
...
public class Generators {
    ...
    static String projectName = "lsoa";

    public static void main(String[] args) throws Exception {
        //单独生成
        generator("Test");
//        //批量生成
//        generator("FamousMartyrs","MartyrsCommendationPolicy"); //换成自已要生成的类名
    }


    //===================
    static String workspacePath = System.getProperty("user.dir");
    static String modelPath = workspacePath + "\\" +projectName+ "-model\\src\\main\\java\\com\\jsdc\\" +projectName+ "\\model\\{className}.java";
    static String voPath = workspacePath + "\\" +projectName+ "-model\\src\\main\\java\\com\\jsdc\\" +projectName+ "\\vo\\{className}Vo.java";
    static String daoPath = workspacePath + "\\" +projectName+ "-api\\src\\main\\java\\com\\jsdc\\" +projectName+ "\\dao\\{className}Dao.java";
    static String mapperPath = workspacePath + "\\" +projectName+ "-api\\src\\main\\java\\com\\jsdc\\" +projectName+ "\\mapper\\{className}Mapper.java";
    static String servicePath = workspacePath + "\\" +projectName+ "-api\\src\\main\\java\\com\\jsdc\\" +projectName+ "\\service\\{className}Service.java";
    static String controllerPath = workspacePath + "\\" +projectName+ "-web\\src\\main\\java\\com\\jsdc\\" +projectName+ "\\controller\\{className}Controller.java";
    static String author = "";//不填
    static SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

    private static String getSVN() {
        String userName = "";
        try {
            Process process = Runtime.getRuntime().exec("svn auth");
            // 获取命令输出
            BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()));
            String line = null;
            //输出BufferedReader 流中的数据 直到结束
            while ((line = reader.readLine()) != null) {
                //打印一行
                //System.out.println(line);
                if (line.startsWith("Username:")) {
                    // System.out.println("Username:"+line.substring(10));
    ...
    private static void generator(String... classNames) throws Exception {
        ...
        for (String className : classNames) {
            ...
            className = org.apache.commons.lang3.StringUtils.trimToEmpty(className);
    ...
    private static String getTable(String className) throws IOException {
        ...
        for (String row : recodesList) {
            row = org.apache.commons.lang3.StringUtils.trimToEmpty(row);
    ...
    static String controllerTemplate = "package com.jsdc.{projectName}.controller;\n" +
            ...
            "    //@ApiOperation(\"XXXX\")\n" +
            "    public ResultInfo getPageList(@RequestBody {className}Vo bean) {\n" +
            ...
            "    //@ApiOperation(\"XXXX\")\n" +
            "    public ResultInfo saveOrUpdate{className}(@RequestBody {className}Vo bean) {\n" +
    ...
    static String serviceTemplate = "package com.jsdc.{projectName}.service;\n" +
            ...
            "\n" +
            "        //Page<{className}Vo> pageList = {classNameX}Mapper.getPageList(new Page<>(vo.getPageNum(), vo.getPageSize()), vo);\n" +

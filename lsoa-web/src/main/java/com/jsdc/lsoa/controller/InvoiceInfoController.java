...
public class InvoiceInfoController {
    ...
    @ApiOperation("根据ID查询")
    public ResultInfo toInvoice(@RequestParam Integer id) {
        return ResultInfo.success(invoiceInfoService.toInvoice(id));
    }
    ...
    public void toExportTemplate(CaseInfoVo bean, HttpServletResponse response) {
        invoiceInfoService.export(bean, response);
    }
    ...
    @PostMapping("/payType")
    @ApiOperation("修改支付状态")
    public ResultInfo payType(@RequestBody InvoiceInfoVo bean) {
        invoiceInfoService.payType(bean);

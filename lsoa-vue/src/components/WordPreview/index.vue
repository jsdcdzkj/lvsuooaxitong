<template>
    <el-drawer :visible="show" size="800px" append-to-body :withHeader="false" :before-close="close">
        <div flex="dir:top main:left cross:top" style="height: 100vh">
    ...
    methods: {
        ...
        preview(index) {
            ...
            if (["webp", "jpg", "jpeg", "png", "gif",'svg'].includes(suffix)) {
                ...
                if (data.file_path) {
                    download({id: data.id}, { responseType: "blob" }).then((res) => {
                        this.showWord = true;
						this.loading = false;
                        this.$nextTick(() => {

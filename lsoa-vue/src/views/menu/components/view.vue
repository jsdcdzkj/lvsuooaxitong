    ...
    <div class="drawer-content">
      ...
      <div class="mt15">
        <el-descriptions :column="2" border>
          <el-descriptions-item label="案件编号" label-class-name="my-label" content-class-name="my-content">{{formInline.name}}</el-descriptions-item>
          <!--        <el-descriptions-item label="任务权限" content-class-name="my-content">正常</el-descriptions-item>-->
          <el-descriptions-item label="争议类别" label-class-name="my-label" content-class-name="my-content">{{formInline.groupDesc}}</el-descriptions-item>
        </el-descriptions>
      </div>

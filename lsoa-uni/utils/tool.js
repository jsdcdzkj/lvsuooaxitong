...
//模态输入框
tool.inputModal = function(content,title='提示',placeholderText='请输入'){
	return new Promise((resolve,reject)=>{
		uni.showModal({
			title,
			content,
...
tool.previewBase64 = function(base64){
	...
	const filePath = `${wx.env.USER_DATA_PATH}/temp_image${new Date().getTime()}.png`;
...
tool.todoStatus = [
	{label: "巡检",value: 0,index: 0},
	{label: '维保',value: 1,index: 1},
	{label: '维修',value: 2,index: 2},
	{label: '任务指派',value: 3,index: 3},
	{label: '审批',value: 4,index: 4},
]
